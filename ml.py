...
classifier=pickle.load(open('C:/Users/Achinthya/Downloads/Groove-master (1)/Groove-master/hack_model/model.sav','rb'))
vectorizer=pickle.load(open('C:/Users/Achinthya/Downloads/Groove-master (1)/Groove-master/hack_model/c_vec.sav','rb'))
