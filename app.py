...
conn=mysql.connector.connect(host="sql6.freemysqlhosting.net",user="sql6454493",password="uHuzLkQa4F",database="sql6454493")
cursor=conn.cursor()
...
def add_user():
    ...
    cursor.execute("""INSERT INTO `users` (`user_id`,`name`,`email`,`password`,`phone_number`,`gender`,`twitter_id`) VALUES (1,'{}','{}','{}','{}','{}','{}')""".format(name,email,password,phone_number,gender,twitter_id))
    conn.commit()
